...
class MyHandler(FileSystemEventHandler):
    ...
    def on_modified(self, event):
        ...
        if event.src_path.endswith("MX28AR.xacro") and current_time - self.last_modified > 1:
...
def monitor_file_changes():
    ...
    file_path = '/home/jaku6m/Humanoid_workspace/src/one_dynamixel_simulation/urdf/MX28AR.xacro'
